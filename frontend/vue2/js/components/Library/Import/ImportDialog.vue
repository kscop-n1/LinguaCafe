<template>
    ...
    >
        <v-card id="import-dialog" class="rounded-lg" :loading="importLoading">
                ...
                >
                    <v-stepper-header>
                        <v-stepper-step
                            ...
                            step="1"
                            :color="stepperPage > 1 ? 'success' : 'primary'"
                        >
                            Type
                        ...
                        <v-stepper-step
                            ...
                            step="2"
                            :color="stepperPage > 2 ? 'success' : 'primary'"
                        >
                            Source
                        ...
                        <v-stepper-step
                            :complete="stepperPage > 3"
                            step="3"
                            :color="stepperPage > 3 ? 'success' : 'primary'"
                        >
                            Book
                        ...
                        <v-stepper-step
                            :complete="stepperPage > 4"
                            step="4"
                            :color="stepperPage > 4 ? 'success' : 'primary'"
                        >
                            Method
            ...
            <v-card-actions>
                <v-spacer></v-spacer>
                <v-btn v-if="importResult === 'success'" rounded text @click="close">Close</v-btn>

                <v-btn rounded text @click="close" v-if="stepperPage == 1">Cancel</v-btn>
                ...
                <v-btn
                    ...
                    :disabled="
                        ...
                        (stepperPage == 2 &&
                            importType === 'e-book' &&
                            (!isImportSourceValid || importFile === null)) ||
                        (stepperPage == 2 &&
