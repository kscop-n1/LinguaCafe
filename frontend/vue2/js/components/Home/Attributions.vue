<template>
    <v-container class="text--text">
        <div class="subheader">Attributions</div>

        LinguaCafe uses many public resources. I am very thankful for these projects and for all the
        people who were working on them. They helped me greatly to create LinguaCafe.<br /><br />
        ...
        <v-card outlined class="rounded-lg mb-6">
            ...
            <v-card-text>
                ...
                <a href="https://github.com/explosion/spaCy/blob/master/LICENSE">Spacy license.</a
                ><br />
            </v-card-text>
        </v-card>
        ...
        <v-card outlined class="rounded-lg mb-6">
            ...
            <v-card-text>
                ...
                <a href="https://github.com/lxyu/pinyin?tab=MIT-1-ov-file#readme">Pinyin license.</a
                ><br />
            </v-card-text>
        </v-card>
        ...
        <v-card outlined class="rounded-lg mb-6">
            ...
            <v-card-text>
                ...
                <a href="https://github.com/codelucas/newspaper/blob/master/LICENSE"
                    >Newspaper3k license.</a
                ><br />
            </v-card-text>
        </v-card>
        ...
        <v-card outlined class="rounded-lg mb-6">
            ...
            <v-card-text>
                ...
                <a href="https://github.com/aerkalov/ebooklib/blob/master/LICENSE.txt"
                    >EbookLib license.</a
                ><br />
            </v-card-text>
        </v-card>
        ...
        <v-card outlined class="rounded-lg mb-6">
            ...
            <v-card-text>
                ...
                <a href="https://www.edrdg.org/jmdict/j_jmdict.html">JMDict Project website.</a
                ><br />
                <a href="https://www.edrdg.org/edrdg/licence.html">JMDict license information.</a
                ><br />
        ...
        <v-card outlined class="rounded-lg mb-6">
            ...
            <v-card-text>
                ...
                <a href="https://www.edrdg.org/jmdict/j_jmdict.html">JMDict Project website.</a
                ><br />
                <a href="https://www.edrdg.org/edrdg/licence.html">KANJIDIC2 license information.</a
                ><br />
                <a href="https://creativecommons.org/licenses/by-sa/4.0/">KANJIDIC2 license.</a
                ><br />
            </v-card-text>
        </v-card>
        ...
        <v-card outlined class="rounded-lg mb-6">
            ...
            <v-card-text>
                ...
                <a href="https://www.edrdg.org/jmdict/j_jmdict.html">JMDict Project website.</a
                ><br />
                <a href="https://www.edrdg.org/edrdg/licence.html">KRADKFILE license information.</a
                ><br />
                <a href="https://creativecommons.org/licenses/by-sa/4.0/">KRADKFILE license.</a
                ><br />
            </v-card-text>
        </v-card>
        ...
        <v-card outlined class="rounded-lg mb-6">
            ...
            <v-card-text>
                ...
                <a href="https://creativecommons.org/licenses/by-sa/3.0/">CC-CEDICT license.</a
                ><br />
            </v-card-text>
        </v-card>
        ...
        <v-card outlined class="rounded-lg mb-6">
            ...
            <v-card-text>
                ...
                <a href="https://creativecommons.org/licenses/by-sa/2.0/de/">HanDeDict license.</a
                ><br />
            </v-card-text>
        </v-card>
        ...
        <v-card outlined class="rounded-lg mb-6">
            ...
            <v-card-text>
                ...
                <a
                    href="https://www.kaggle.com/datasets/rtatman/eurfa-welsh-dictionary?resource=download"
                    >Eurfa download website</a
                ><br />
                ...
                <a href="https://bitbucket.org/donnek/eurfa/src/master/gpl.txt">Eurfa license</a
                ><br />
            </v-card-text>
        </v-card>
        ...
        <v-card outlined class="rounded-lg mb-6">
            ...
            <v-card-text>
                LinguaCafe has no dict.cc dictionaries packaged in the software. It only provides a
                link to the dict.cc website.<br /><br />

                <a href="https://www1.dict.cc/translation_file_request.php?l=e">Dict.cc license.</a
                ><br />
            </v-card-text>
        </v-card>
        ...
        <v-card outlined class="rounded-lg mb-6">
            ...
            <v-card-text>
                ...
                <a href="https://github.com/mbilbille/dmak/blob/master/LICENSE">DMAK license.</a
                ><br />
            </v-card-text>
        </v-card>
