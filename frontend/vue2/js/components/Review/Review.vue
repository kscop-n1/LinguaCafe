<template>
    ...
    >
        ...
        <review-hotkey-information-dialog v-model="hotkeyDialog"></review-hotkey-information-dialog>
        ...
        >
            ...
            <template v-if="totalReviews === 0">
                ...
                <!-- Card content -->
                <v-card-text> There are no words or phrases to be reviewed. </v-card-text>
            </template>
        ...
        <div id="review" v-if="!finished">
            ...
            <div id="review-progress-line" class="d-flex align-center">
                <v-badge left overlap color="success" icon="mdi-check">
                    <div
                ...
                <v-badge overlap color="error" icon="mdi-cards">
                    <div id="progress-bar-remaining-counter" class="border">
            ...
            <div id="toolbar">
                ...
                <v-menu offset-y left class="rounded-lg">
                    ...
                    <v-btn
                        ...
                        color="white"
                        @click="
                            settings.reviewSentenceMode = 'disabled'
                            saveSettings()
                        "
                    >
                    ...
                    <v-btn
                        ...
                        color="white"
                        @click="
                            settings.reviewSentenceMode = 'plain-text'
                            saveSettings()
                        "
                    >
                    ...
                    <v-btn
                        ...
                        color="white"
                        @click="
                            settings.reviewSentenceMode = 'interactive-text'
                            saveSettings()
                        "
                    >
                ...
                <v-btn title="Increase font size" icon class="my-2" @click="increaseFontSize"
                    ><v-icon>mdi-magnify-plus</v-icon></v-btn
                >
                <v-btn title="Decrease font size" icon class="my-2" @click="decreaseFontSize"
                ...
                <div class="vocab-box-area">
                    <div id="review-card-content">
                        ...
                        <div id="review-card-front" class="rounded-lg border">
                            ...
                            <template
                                v-if="
                                    ...
                                    reviews[currentReviewIndex].type == 'word'
                                "
                            >
                                ...
                                <!-- Single word  mode -->
                                <div
                                    class="single-word selected-font"
                                    v-if="!settings.reviewSentenceMode"
                                    :style="{ 'font-size': settings.fontSize + 'px' }"
                                >
                                    <template v-if="reviews[currentReviewIndex].lemma !== ''"
                                        >{{ reviews[currentReviewIndex].lemma }}
                            ...
                            >
                                <!-- Phrase only mode -->
                                <div
                                    class="phrase-words selected-font"
                                    :style="{ 'font-size': settings.fontSize + 'px' }"
                                >
                            ...
                            <div class="review-button-box">
                                <v-btn
                                    ...
                                    v-if="
                                        ...
                                        !newCardAnimation &&
                                        !backToDeckAnimation &&
                                        !intoTheCorrectDeckAnimation
                                    "
                                    ><v-icon>mdi-rotate-3d-variant</v-icon> Reveal</v-btn
                                >
                            </div>
                        </div>
                        ...
                        >
                            ...
                            >
                                ...
                                <template
                                    v-if="
                                        ...
                                        reviews[currentReviewIndex].lemma !== ''
                                    "
                                    >{{ reviews[currentReviewIndex].lemma_reading }}
                                    <v-icon>mdi-arrow-right-thick</v-icon>
                                </template>
                            ...
                            <div
                                id="translation"
                                v-if="reviews[currentReviewIndex] !== undefined"
                                :style="{ 'font-size': settings.fontSize + 'px' }"
                            >
...
export default {
    ...
    methods: {
        ...
        saveSettings() {
            ...
            DefaultLocalStorageManager.saveSetting(
                'vocabularyHoverBoxDelay',
                this.settings.vocabularyHoverBoxDelay
            )
            DefaultLocalStorageManager.saveSetting(
                'vocabularyHoverBoxPreferredPosition',
                this.settings.vocabularyHoverBoxPreferredPosition
            )
            DefaultLocalStorageManager.saveSetting(
                'vocabularyBottomSheet',
                this.settings.vocabularyBottomSheet
            )
        },
        increaseFontSize() {
        ...
        reveal() {
            ...
            if (
                this.$refs.textBlock !== undefined &&
                this.settings.reviewSentenceMode === 'interactive-text'
            ) {
            ...
            if (!this.reviews[this.currentReviewIndex].relearning && !this.practiceMode) {
                if (this.reviews[this.currentReviewIndex].stage > -7) {
                    ...
                    this.reviews[this.currentReviewIndex].stage =
                        this.reviews[this.currentReviewIndex].stage - 1
                    saveData.stage = this.reviews[this.currentReviewIndex].stage
                }
            }
