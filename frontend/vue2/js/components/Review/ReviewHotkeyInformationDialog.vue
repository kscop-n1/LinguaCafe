    ...
    <v-dialog v-model="value" persistent width="400px" height="500px">
        <v-card class="rounded-lg">
            ...
            <v-card-text class="px-8">
                <div class="d-flex">
                    <span class="primary--text mr-6" style="width: 80px">Enter</span
                    ><span>Reveal button</span>
                </div>

                <div class="d-flex">
                    <span class="primary--text mr-6" style="width: 80px">.</span
                    ><span>I was correct button</span>
                </div>
