...
class TextStylingService {
	...
	getCssSettingObject(textStylingSettings, theme, level) {
		...
		cssVariables[`--interactive-text-${levelMapping[level]}-color`] =
			textStylingSettings[theme][level].textColor
		cssVariables[`--interactive-text-${levelMapping[level]}-border-color`] =
			textStylingSettings[theme][level].borderColor
		cssVariables[`--interactive-text-${levelMapping[level]}-border-style`] =
			textStylingSettings[theme][level].borderStyle
		cssVariables[`--interactive-text-${levelMapping[level]}-border-radius`] =
			textStylingSettings[theme][level].borderRadius + 'px'

		// padding
		cssVariables[`--interactive-text-${levelMapping[level]}-padding-top`] =
			textStylingSettings[theme][level].paddingTop + 'px'
		cssVariables[`--interactive-text-${levelMapping[level]}-padding-bottom`] =
			textStylingSettings[theme][level].paddingBottom + 'px'
		...
		// add colors
		cssVariables[`--interactive-text-${levelMapping[level]}-background-transparency`] =
			textStylingSettings[theme][level].backgroundTransparency + '%'
		cssVariables[`--interactive-text-${levelMapping[level]}-border-color`] =
			textStylingSettings[theme][level].borderColor
		cssVariables[`--interactive-text-${levelMapping[level]}-background-color`] =
			textStylingSettings[theme][level].backgroundColor
		cssVariables[`--interactive-text-${levelMapping[level]}-color`] =
			textStylingSettings[theme][level].textColor

		// set top border
		if (
			!textStylingSettings[theme][level].borderTop ||
			!textStylingSettings[theme][level].borderWidth
		) {
			cssVariables[`--interactive-text-${levelMapping[level]}-border-top-width`] = '0px'
		} else {
			cssVariables[`--interactive-text-${levelMapping[level]}-border-top-width`] =
				textStylingSettings[theme][level].borderWidth + 'px'
		}

		// set bottom border
		if (
			!textStylingSettings[theme][level].borderBottom ||
			!textStylingSettings[theme][level].borderWidth
		) {
			cssVariables[`--interactive-text-${levelMapping[level]}-border-bottom-width`] = '0px'
		} else {
			cssVariables[`--interactive-text-${levelMapping[level]}-border-bottom-width`] =
				textStylingSettings[theme][level].borderWidth + 'px'
		}

		// set side borders
		if (
			!textStylingSettings[theme][level].borderSides ||
			!textStylingSettings[theme][level].borderWidth
		) {
			...
			cssVariables[`--interactive-text-${levelMapping[level]}-border-left-width`] =
				textStylingSettings[theme][level].borderWidth + 'px'
			cssVariables[`--interactive-text-${levelMapping[level]}-border-right-width`] =
				textStylingSettings[theme][level].borderWidth + 'px'
		}
		...
		if (textStylingSettings[theme][level].wavyUnderline) {
			...
			cssVariables[`--interactive-text-${levelMapping[level]}-wave-width`] =
				textStylingSettings[theme][level].borderWidth + 'px'
			cssVariables[`--interactive-text-${levelMapping[level]}-border-bottom-width`] = '0px'
			cssVariables[`--interactive-text-${levelMapping[level]}-border-top-width`] = '0px'
			cssVariables[`--interactive-text-${levelMapping[level]}-border-left-width`] = '0px'
