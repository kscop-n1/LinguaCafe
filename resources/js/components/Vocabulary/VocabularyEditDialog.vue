        ...
        >
            ...
            <v-card-text class="d-flex flex-wrap" v-if="item">
                ...
                <div id="vocabulary-edit-chips" class="pb-4">
                    ...
                    >
                        {{ item.lookup_count }} lookups<v-icon
                            :small="$vuetify.breakpoint.smAndDown"
                            right
                            class="ml-1"
                            >mdi-magnify</v-icon
            ...
            <v-card-actions v-if="!loading">
                ...
                <v-btn rounded depressed color="primary" :disabled="saved || saving" @click="save"
                    >Save</v-btn
                >
            </v-card-actions>
        </v-card>
