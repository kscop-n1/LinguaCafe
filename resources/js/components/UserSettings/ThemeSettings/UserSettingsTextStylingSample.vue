	...
	data: function () {
		return {
			...
			multiLingualSampleTexts: {
				english:
					"LinguaCafe is a platform designed to help you practice and improve your language skills through reading. Whether you're just starting to learn or looking to read more advanced material, there's something for everyone. You can explore articles, stories, and other reading materials that fit your level and interests. The platform makes learning feel more natural by exposing you to real language use in everyday contexts. You’ll also find helpful tools, like vocabulary lists and translation aids, that support your learning without interrupting the flow of your reading. Whether you're learning for fun or for more serious study, LinguaCafe is a simple way to stay connected with the language.",
				japanese:
					'LinguaCafe は 、 読む ことで 言語 スキル を 練習 し 、 向上 させる ため の プラットフォーム です 。 初心者 から 上級者 まで 、 自分 の レベル に 合った 内容 を 見つける こと が できます 。 記事 や 物語 など 、 興味 や レベル に 合わせた 読み物 を 楽しむ こと が でき 、 日常的 な 文脈 で 使われる 言語 に 触れる こと が できます 。 語彙 リスト や 翻訳 ツール など 、 学習 を サポート する 便利 な ツール も あり 、 読む 楽しさ を 損なう こと なく 進められます 。 楽しく 学ぶ こと も 、 真剣 に 学びたい こと も できる LinguaCafe は 、 言語 と の つながり を 保つ シンプル な 方法 です 。',
				chinese:
					'LinguaCafe 是 一 个 平台 ， 旨在 通过 阅读 帮助 你 练习 和 提高 语言 技能 。 无论 你 是 刚 开始 学习 ， 还是 希望 阅读 更 高级 的 材料 ， 都 能 找到 适合 自己 的 内容 。 你 可以 阅读 文章 、 故事 和 其他 符合 自己 水平 和 兴趣 的 材料 ， 接触 到 日常 生活 中 使用 的 语言 。 平台 还 提供 了 有用 的 工具 ， 比如 词汇表 和 翻译 工具 ， 帮助 你 在 阅读 的 同时 继续 学习 ， 而 不会 打断 阅读 的 流畅性 。 不论 是 为了 娱乐 还是 为了 更 严肃 的 学习 ， LinguaCafe 都 是 一 个 保持 与 语言 联系 的 简单 方法 。',
