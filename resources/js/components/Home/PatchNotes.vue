<template>
    <v-container>
        <div class="subheader">Update notes</div>
        ...
        <v-card outlined class="rounded-lg mb-8">
            ...
            <v-card-text>
                <b>Bug fixes:</b>
                <ul>
                    <li>Fixed a serious security issue.</li>
                </ul>
            </v-card-text>
        </v-card>
        ...
        <v-card outlined class="rounded-lg mb-8">
            ...
            <v-card-text>
                <b>Bug fixes:</b>
                <ul>
                    <li>Fixed unusable Spanish goals after creating the first user.</li>
                </ul>
            </v-card-text>
        </v-card>
        ...
        <v-card outlined class="rounded-lg mb-8">
            ...
            <v-card-text>
                <b>Bug fixes:</b>
                <ul>
                    <li>Fixed Polish font file name, which did not load previously.</li>
                </ul>
            </v-card-text>
        </v-card>
        ...
        <v-card outlined class="rounded-lg mb-8">
            ...
            <v-card-text>
                <b>Bug fixes:</b>
                <ul>
                    <li>Fixed a bug that caused practice review mode to be always turned off.</li>
                </ul>
            </v-card-text>
        </v-card>
        ...
        <v-card outlined class="rounded-lg mb-8">
            ...
            <v-card-text>
                <b>Bug fixes:</b>
                <ul>
                    <li>Fixed annoying multi word text selection bug.</li>
                    <li>Fixed furigana.</li>
                    <li>Fixed plain text mode.</li>
                </ul>
            </v-card-text>
        </v-card>
        ...
        <v-card outlined class="rounded-lg mb-8">
            ...
            <v-card-text>
                ...
                <b>Other changes:</b>
                <ul>
                    <li>The default language has been changed to Spanish.</li>
                </ul>
            </v-card-text>
        </v-card>
        ...
        <v-card outlined class="rounded-lg mb-8">
            ...
            <v-card-text>
                <b>Bug fixes:</b>
                <ul>
                    <li>Fixed a bug that disabled some hotkeys.</li>
                </ul>
            </v-card-text>
        </v-card>
        ...
        <v-card outlined class="rounded-lg mb-8">
            ...
            <v-card-text>
                <b>New features:</b>
                <ul>
                    <li>Added a new default list layout for the library page.</li>
                    <li>Added a logout confirmation dialog.</li>
                    <li>Added theme customization.</li>
                    <li>Added different background colors for different word levels.</li>
                    <li>Added a separate color for ignored words' text color.</li>
                    <li>Added a hotkey to set words' level back to new.</li>
                </ul>
                ...
                <ul>
                    ...
                    <li>Made navigation sidebar more compact.</li>
                </ul>
            </v-card-text>
        </v-card>
        ...
        <v-card outlined class="rounded-lg mb-8">
            ...
            <v-card-text>
                <b>New features:</b>
                <ul>
                    <li>Added new supported languages: English, Greek and Latin.</li>
                ...
                <b>Other changes:</b>
                <ul>
                    <li>MacOS users have a new, simpler install and update process.</li>
                </ul>
            </v-card-text>
        </v-card>
        ...
        <v-card outlined class="rounded-lg mb-8">
            ...
            <v-card-text>
                ...
                <ul>
                    ...
                    <li>Added user manual. Will be extended and updated regularly.</li>
                </ul>
        ...
        <v-card outlined class="rounded-lg mb-8">
            ...
            <v-card-text>
                ...
                <ul>
                    ...
                    <li>The selected library layout will now be remembered.</li>
                    <li>Added option to change the default MySQL database and user.</li>
                    <li>Added windows installation guide and installation file.</li>
                </ul>
        ...
        <v-card outlined class="rounded-lg mb-8">
            ...
            <v-card-text>
                ...
                <ul>
                    ...
                    <li>Added proper finish reading screen.</li>
                </ul>
                ...
                <b>Other changes:</b>
                <ul>
                    <li>Updated node.js to v20.11.0.</li>
                </ul>
            </v-card-text>
        </v-card>
        ...
        <v-card outlined class="rounded-lg mb-8">
            ...
            <v-card-text>
                <b>Bug fixes:</b>
                <ul>
                    <li>Fixed a problem with deployment, and added a simple migration guide.</li>
                </ul>
            </v-card-text>
        </v-card>
        ...
        <v-card outlined class="rounded-lg mb-8">
            ...
            <v-card-text>
                <b>Bug fixes:</b>
                <ul>
                    <li>Fixed a bug that prevented lemmas end lemma readings to be saved.</li>
                </ul>
            </v-card-text>
        </v-card>
        ...
        <v-card outlined class="rounded-lg mb-8">
            ...
            <v-card-text>
                ...
                <b>New features:</b>
                <ul>
                    <li>Added support for new languages: Czech and Welsh.</li>
                    <li>Added Kengdic dictionary support for Korean.</li>
                    <li>Added CC-CEDICT dictionary support for Chinese.</li>
                    <li>Added Eurfa dictionary support for Welsh.</li>
                    <li>Added pinyin support for Chinese.</li>
                    <li>Added furigana support for Japanese.</li>
                </ul>
        ...
        <v-card outlined class="rounded-lg mb-8">
            ...
            <v-card-text> Release. </v-card-text>
        </v-card>
    </v-container>
</template>
