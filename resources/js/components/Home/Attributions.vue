	...
	<v-container class="text--text">
		...
		<v-card outlined class="rounded-lg mb-6">
			...
			<v-card-text>
				...
				<a href="https://github.com/codelucas/newspaper/blob/master/LICENSE">Newspaper3k license.</a
				><br />
			</v-card-text>
		</v-card>
		...
		<v-card outlined class="rounded-lg mb-6">
			...
			<v-card-text>
				...
				<a href="https://github.com/aerkalov/ebooklib/blob/master/LICENSE.txt">EbookLib license.</a
				><br />
			</v-card-text>
		</v-card>
		...
		<v-card outlined class="rounded-lg mb-6">
			...
			<v-card-text>
				...
				<a href="https://www.gnu.org/licenses/old-licenses/lgpl-2.0.en.html">Kengdic license.</a
				><br />
			</v-card-text>
		</v-card>
		...
		<v-card outlined class="rounded-lg mb-6">
			...
			<v-card-text>
				...
				<a href="https://www.kaggle.com/datasets/rtatman/eurfa-welsh-dictionary?resource=download"
		...
		<v-card outlined class="rounded-lg mb-6">
			...
			<v-card-text>
				LinguaCafe has no dict.cc dictionaries packaged in the software. It only provides a link to
				the dict.cc website.<br /><br />
