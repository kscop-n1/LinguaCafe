<template>
	<div>
		<v-container id="home" class="pb-12">
			...
			<template v-if="!passwordChanged">
				...
				>
					...
					<div class="d-flex mt-4">
						<v-spacer />
						<v-btn rounded depressed color="error" @click="passwordChangeDialog = true">
			...
			<calendar ref="calendar" @achievement-quantity-change="updateGoals"></calendar>

			<continue-reading />

			<goals ref="goals" @goal-quantity-change="updateCalendar"></goals>
			<statistics ref="statistics"></statistics>

			<div class="subheader subheader-margin-top d-flex">About</div>
			...
			<div id="about" class="d-flex flex-wrap">
				<v-card outlined class="rounded-lg pt-0 mr-4 mb-4" width="290px">
					...
					<v-card-text>
						...
						<div class="footer-link-box mb-1">
							<a href="https://simjanos-dev.github.io/LinguaCafeHome/"
								><v-icon class="mr-2">mdi-file-document</v-icon>Overview</a
							>
						</div>
					</v-card-text>
				</v-card>
				...
				<v-card outlined class="rounded-lg pt-0 mr-4 mb-4" width="290px">
					...
					<v-card-text>
						...
						<div class="footer-link-box mb-1 mt-4">
							<a href="https://discord.gg/wZYZYrdaeP"
								><v-icon class="mr-2">mdi-message-text</v-icon>Discord chat</a
							>
						</div>
						<div class="footer-link-box mb-1">
							<a href="https://github.com/simjanos-dev/LinguaCafe"
								><v-icon class="mr-2">mdi-github</v-icon>Github</a
							>
						</div>
						<div class="footer-link-box mb-1">
							<a href="https://www.reddit.com/r/linguacafe/"
								><v-icon class="mr-2">mdi-reddit</v-icon>Reddit</a
							>
						</div>
					</v-card-text>
				</v-card>
					...
					<v-card-text>
						...
						<div class="footer-link-box mb-1 mt-4">
							<router-link to="/patch-notes"
								><v-icon class="mr-2">mdi-update</v-icon>Update notes</router-link
							>
						</div>
					</v-card-text>
				</v-card>
