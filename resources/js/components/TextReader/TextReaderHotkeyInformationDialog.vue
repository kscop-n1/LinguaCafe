	...
	<v-dialog v-model="value" persistent scrollable width="460px">
		<v-card id="text-reader-hotkeys" class="rounded-lg" height="500px">
			...
			<v-card-text class="px-8">
				...
				<div class="hotkey d-flex">
					<span class="primary--text" style="width: 170px">Right arrow</span
					><span>Select next word</span>
				</div>
				<div class="hotkey d-flex">
					<span class="primary--text" style="width: 170px">Shift + Left arrow</span
					><span>Select previous highlighted word</span>
				</div>
				<div class="hotkey d-flex">
					<span class="primary--text" style="width: 170px">Shift + Right arrow</span
					><span>Select next highlighted word</span>
				</div>
				<div class="hotkey d-flex">
					<span class="primary--text" style="width: 170px">Ctrl + Left arrow</span
					><span>Select previous new word</span>
				</div>
				<div class="hotkey d-flex">
					<span class="primary--text" style="width: 170px">Ctrl + Right arrow</span
				...
				<div class="hotkey d-flex">
					<span class="primary--text" style="width: 170px">Shift + d</span
					><span>Select next highlighted word</span>
				</div>
				<div class="hotkey d-flex">
					<span class="primary--text" style="width: 170px">Ctrl + a</span
					><span>Select previous new word</span>
				</div>
				<div class="hotkey d-flex">
					<span class="primary--text" style="width: 170px">Ctrl + d</span
					><span>Select next new word</span>
				</div>
