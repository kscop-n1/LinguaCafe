        ...
        <v-card outlined class="book opened detailed rounded-lg mx-auto my-6">
            ...
            <div class="book-box">
                ...
                <v-card-text class="book-information pa-0 pl-3">
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    <div class="info-table-value">
                                        {{ formatNumber(book.wordCount.total) }}
                                    </div>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td class="text-center">
                                    <div class="info-table-value">
                                        {{ formatNumber(book.wordCount.unique) }}
                                    </div>
                                </td>
                            </tr>
                            <tr>
                    ...
                    <v-card-actions>
                        <v-spacer />
                        <v-btn rounded class="mx-0" color="primary" @click="addChapter"
                            ><v-icon> mdi-plus</v-icon>Add chapter</v-btn
                        >
                    </v-card-actions>
                </v-card-text>
            </div>
        ...
        <v-card outlined class="book opened detailed rounded-lg mx-auto my-6">
            <v-card-title class="book-title pa-3">
                ...
                >
                    ...
                    <v-btn small class="px-1" min-width="40px"> Mixed </v-btn>
                    <v-btn small class="px-1" min-width="40px">
...
export default {
    ...
    methods: {
        ...
        loadBookWordCounts() {
            ...
            axios.get('/api/library/books/word-counts/' + this.book.id).then(response => {
