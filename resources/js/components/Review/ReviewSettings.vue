<template>
	<v-dialog v-model="value" scrollable persistent max-width="1000">
		<v-card id="review-settings" outlined class="rounded-lg">
			<v-card-title>
			...
			<v-card-text class="pt-6 pb-12" v-if="settingsLoaded">
				<!-- Text section-->
				<div class="subheader d-flex mb-2">Text</div>
				...
				<div class="subheader subheader-margin-top d-flex mb-2">Vocabulary box</div>
				...
				<div class="subheader subheader-margin-top d-flex mb-2">Vocabulary hover box</div>
				...
				<div class="subheader subheader-margin-top d-flex mb-2">Text to speech</div>
