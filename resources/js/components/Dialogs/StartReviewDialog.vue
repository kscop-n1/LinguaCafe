<template>
	<v-dialog v-model="value" persistent max-width="500px">
		<v-card class="rounded-lg">
			...
			<v-card-text>
				<!-- Book name -->
				<span v-if="bookName !== ''">Book: {{ bookName }}</span
				><br />
			...
			<v-card-actions class="mt-8">
				...
				<v-menu offset-y left nudge-top="-12px" nudge-left="-88px">
					...
					<v-card outlined class="rounded-lg pa-4" width="252px">
						...
						<ul class="mb-0">
							<li>Your words' and phrases' review due date will not change.</li>
							<li>Your words' and phrases' level will not change.</li>
							<li>Your reviews do not count in daily review goals.</li>
							<li>You will also get cards which are due to a later date.</li>
						</ul>
					</v-card>
				</v-menu>
