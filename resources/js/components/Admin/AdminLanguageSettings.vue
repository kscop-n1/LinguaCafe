<template>
	<div id="admin-language-settings">
		...
		<admin-uninstall-languages-dialog v-model="uninstallLanguagesDialog" />
		...
		<v-simple-table class="no-hover border rounded-lg" v-if="!languages.length">
			...
			<tbody>
				<tr v-for="skeletonindex in 7" :key="skeletonindex">
					<!-- Flag skeleton -->
					<td>
						<v-skeleton-loader class="rounded" type="card"></v-skeleton-loader>
					</td>

					<!-- Language skeleton-->
					<td>
						<v-skeleton-loader class="rounded-pill" type="card"></v-skeleton-loader>
					</td>
