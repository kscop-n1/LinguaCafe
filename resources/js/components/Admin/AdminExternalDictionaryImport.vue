<template>
    ...
    >
        ...
        <v-card-text>
            ...
            >
                ...
                <v-stepper-header>
                    ...
                    <v-stepper-step :complete="stepperPage > 4" step="4"> Finish </v-stepper-step>
                </v-stepper-header>
                ...
                <v-stepper-items>
                    ...
                    <v-stepper-content step="2">
                        ...
                        <v-alert
                            ...
                            dark
                        >
                            The file has been tested without any errors. It contains
                            {{ fileRecordCount }} records.
                        </v-alert>
                    </v-stepper-content>
                        ...
                        <v-simple-table class="border no-hover rounded-lg" v-if="dictionary.file">
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        {{ dictionary.name }} ({{
                                            dictionary.databasePrefix + dictionary.databaseName
                                        }})
                                    </td>
                                </tr>
                                <tr>
        ...
        <v-card-actions>
            <v-spacer></v-spacer>
            <v-btn v-if="stepperPage == 1" rounded text @click="backToDictionaries">Back</v-btn>
            ...
            <v-btn v-if="stepperPage == 4 && importResult == 'success'" rounded text @click="close">
                Close
            </v-btn>
            <v-btn
                v-if="stepperPage < 3"
...
export default {
    ...
    methods: {
        updateDatabaseName() {
            this.dictionary.databasePrefix =
                'dict_' + this.databaseNameLanguageCodes[this.dictionary.sourceLanguage] + '_'
            this.dictionary.databaseName = this.dictionary.name
                .split(' ')
                .join('_')
                .toLowerCase()
                .replace(/[^a-z0-9_]/g, '')
