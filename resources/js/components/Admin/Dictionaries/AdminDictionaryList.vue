            ...
            >
                ...
                <template v-slot:item.source_language="{ item }">
                    <v-img
                        ...
                        :src="'/images/flags/' + item.source_language + '.png'"
                        max-width="43"
                        height="28"
                    />
                </template>
                ...
                <template v-slot:item.target_language="{ item }">
                    <v-img
                        class="mx-auto border"
                        :src="'/images/flags/' + item.target_language + '.png'"
                        max-width="43"
                        height="28"
                    />
                </template>
                ...
                <template v-slot:item.actions="{ item }">
                    <v-btn icon title="Edit" @click="editDictionary(item.id)">
