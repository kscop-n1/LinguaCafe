                ...
                dictionaryName: [
                    value => {
                        ...
                        if (
                            ...
                            value.toLowerCase().includes('deepl')
                        ) {
                            this.dictionary.nameValidated = false
    ...
    methods: {
        setSourceLanguages(languages) {
            ...
            languages.forEach(dictionary => {
                if (
                    this.$props.selectedDictionaryType === 'deepl' &&
                    dictionary.linguacafeSupport !== true
                ) {
                    return
                }
                ...
                if (
                    this.$props.selectedDictionaryType === 'libretranslate' &&
                    dictionary.libreTranslateCode === null
                ) {
                    return
                }
        ...
        validateForm() {
            this.dictionary.languagesValid =
                this.dictionary.sourceLanguage !== this.dictionary.targetLanguage
